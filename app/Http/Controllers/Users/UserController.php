...
class UserController extends Controller
{
	public function index(){
        ...
        ->select('a.id','a.name','a.lastname','a.estatus','a.dni','a.tipo','a.email','a.role_id','b.name as rol')
  ...
  public function delete($id){
    $users = User::find($id);
    $users->estatus=0;
    $users->save();    return redirect()->action('Users\UserController@index', ["deleted" => true, "users" => User::all()]);
  }
