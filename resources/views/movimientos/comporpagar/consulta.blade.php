		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span>Movimientos/Comisiones Por Pagar Consultas</span>
			...
			{!! Form::open(['method' => 'get', 'route' => ['comporpagar.consulta']]) !!}
			...
			{!! Form::open(['method' => 'get', 'route' => ['comporpagar.consulta1']]) !!}
					...
					<tbody>
                          @foreach($atenciones as $atec)	
							...
							<tr>
								...
								<td>{{number_format($atec->pagar, 2, ',', '.')}}</td>
								<td>{{$atec->created_at}}</td>
								<td><a href="{{asset('/pagarcom1')}}/{{$atec->id}}" onclick="return confirm('¿Desea Pagar esta Comisión?')" class="btn btn-xs btn-danger">Pagar</a></td>
							</tr>
						@endforeach
					</tbody>
					<tfoot>
